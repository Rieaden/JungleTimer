...
public class AppCore {
	...
	public static ArrayList<String> listParamDefault = new ArrayList<String>() {/**
	 * 
	 */
			...
			public static void loadParameters()
			{
				...
				if(!(new File(fichier)).exists())
				{
					...
					try {
						...
						for(int i = 0; i < AppCore.listParamDefault.size(); i++)
						{
							fichierSortie.println(AppCore.listParamDefault.get(i));
						}
				...
				if(listParam.get(8).substring(listParam.get(8).lastIndexOf(" ")+1).contains("YES"))
				{
					stateOverlay = true;
				}
				else
